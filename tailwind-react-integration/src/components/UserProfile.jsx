...
function UserProfile() {
  return (
    <div className="bg-gray-100 p-8 md:max-w-sm mx-auto my-20 rounded-lg shadow-lg sm:p-4 md:p-8 sm:max-w-xs hover:shadow-xl cursor-pointer">
      ...
      <h1 className=" md:text-xl sm:text-lg text-blue-800 my-4 hover:text-blue-500 cursor-pointer">John Doe</h1>
